...
{
  { FRAMEWIN_CreateIndirect, FILE_BROWSER/*"File Browser"*/, ID_FRAMEWIN, 0, 0, 480, 246, 0, 0x64, 0 },
  { BUTTON_CreateIndirect, REFRESH /*"Refresh"*/, ID_BUTTON_REFRESH, 365, 182, 95, 35, 0, 0x0, 0 },
...
static char lfn[_MAX_LFN];
  ...
  case WM_INIT_DIALOG:
    ...
    sprintf(str, "%02hu/%02hu/%hu %02hu:%02hu:%02hu",(uint16_t)(( fno.fdate) & 0x1F),  
                                                (uint16_t)(((fno.fdate) >> 5) & 0x0F),
                                                (uint16_t)((((fno.fdate) >> 9) & 0x3F) + 1980),
                                                (uint16_t)(((fno.ftime) >> 11) & 0x1F),
                                                (uint16_t)(((fno.ftime) >> 5)  & 0x3F),
                                                (uint16_t)((fno.ftime) & 0x1F));
...
static void _cbHint(WM_MESSAGE * pMsg) 
{
  ...
  case WM_PAINT:
    ...
    GUI_DispStringHCenterAt(POPULATING_TREE_VIEW, 110 , 10);
