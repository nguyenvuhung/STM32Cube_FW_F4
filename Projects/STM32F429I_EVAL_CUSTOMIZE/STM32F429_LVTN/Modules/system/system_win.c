...
static const GUI_WIDGET_CREATE_INFO _aDialogSystemInformation[] = {
	{ WINDOW_CreateIndirect, SYSTEM_INFORMATION /*"System Information"*/, 0, 0, 0, 329, 202, FRAMEWIN_CF_MOVEABLE },
	{ TEXT_CreateIndirect, "Board : STM324F429IIT6", ID_TEXT_BOARD, 40, 24, 280, 20, 0, 0x0, 0 },
	{ TEXT_CreateIndirect, "Core: STM32F429IIT6", ID_TEXT_CORE, 40, 44, 280, 20, 0, 0x0, 0 },
	{ TEXT_CreateIndirect, CPU_SPEED, ID_TEXT_CPU, 40, 64, 280, 20, 0, 0x0, 0 },
	...
	{ TEXT_CreateIndirect, "Copyright (c) VuHung 2014", ID_TEXT_COPYRIGHT, 40, 142, 280, 20, 0, 0x0, 0 },
};

static const GUI_WIDGET_CREATE_INFO _aDialogGeneralSettings[] = {
	{ WINDOW_CreateIndirect, GENERAL_SETTINGS/* "General Settings"*/, 0, 0, 0, 329, 202, FRAMEWIN_CF_MOVEABLE },
	...
	{ TEXT_CreateIndirect, RESTART, ID_TEXT_WARNING, 6, 160, 300, 20, 0, 0x0, 0 },
};

static const GUI_WIDGET_CREATE_INFO _aDialogClockSettings[] = {
	{ WINDOW_CreateIndirect, CLOCK_SETTINGS/*"Clock Settings"*/, 0, 0, 0, 329, 202, FRAMEWIN_CF_MOVEABLE },
	...
	{ BUTTON_CreateIndirect, APPLY/*"Apply settings"*/, ID_BUTTON_APPLYSETTINGS, 195, 140, 116, 37, 0, 0x0, 0 },
};
...
//    TEXT_SetFont(hItem, GUI_FONT_13HB_ASCII);
    ...
    IMAGE_SetBitmap(hItem, &bmBKLogo40x20);
...
static void _cbClockSettings(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    SPINBOX_SetRange(hItem, 0, 59);
		...
		hItem = WM_GetDialogItem(pMsg->hWin, ID_BUTTON_APPLYSETTINGS);
		BUTTON_SetFont(hItem, &GUI_FontTimesNewRoman15);
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    FRAMEWIN_AddCloseButton(hItem, FRAMEWIN_BUTTON_RIGHT, 0);
		FRAMEWIN_SetTextAlign(hItem, GUI_TA_VCENTER| GUI_TA_HCENTER);
		FRAMEWIN_SetFont(hItem, &GUI_FontTimesNewRoman17_B);
   ...
   /* Create and attache the MULTIPAGE dialog windows */
    ...
    MULTIPAGE_AddPage(hItem, hDialog, SYSTEM_INFORMATION);
