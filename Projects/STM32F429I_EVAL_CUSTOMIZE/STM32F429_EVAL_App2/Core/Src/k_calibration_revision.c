...
static void _GetPhysValues(int LogX, int LogY, int * pPhysX, int * pPhysY, const char * pString) {
  char acText[] = "Nh\xe1\xba\xa5n v\xc3\xa0o \xc4\x91\xc3\xa2y";//"Press here";
  GUI_RECT Rect;
  GUI_PID_STATE State;
  int FontSizeY, Align;
  ...
  _DispStringCentered("Ch\xe1\xba\xa1m v\xc3\xa0o t\xc3\xa2m \xc4\x91i\xe1\xbb\x83m b\xe1\xba\xb1ng b\xc3\xbat"
											/*"Runtime calibration,\n"
...
static void _Explain(void) {
  _DispStringCentered("B\xe1\xba\xa1n c\xe1\xba\xa7n c\xc3\xa2n ch\xe1\xbb\x89nh m\xc3\xa0n h\xc3\xacnh c\xe1\xba\xa3m \xe1\xbb\xa9ng\n"

"t\xe1\xba\xa1i l\xe1\xba\xa7n \xc4\x91\xe1\xba\xa7u ti\xc3\xaan s\xe1\xbb\xad d\xe1\xbb\xa5ng\n"

"Vui l\xc3\xb2ng ch\xe1\xba\xa1m v\xc3\xa0o m\xc3\xa0n h\xc3\xacnh \xc4\x91\xe1\xbb\x83 ti\xe1\xba\xbfp t\xe1\xbb\xa5""c..."
                      /*"At first time, you need to\n"
                      "calibrate the Touch screen\n"
                      "Please press the touch\n"
                      "screen to continue..."*/);
  GUI_DispStringHCenterAt("C\xc3\xa2n ch\xe1\xbb\x89nh m\xc3\xa0n h\xc3\xacnh c\xe1\xba\xa3m \xe1\xbb\xa9ng"/*"Touch screen Calibration"*/, LCD_GetXSize() / 2, 5);
  _WaitForPressedState(1);
  _WaitForPressedState(0);
}
...
void k_CalibrationInit(void)
{
  ...
  if(data2.b.IsCalibrated == 0)
  {
   ...
   // GUI_SetFont(&GUI_Font13B_ASCII);
    ...
    GUI_Clear();
    _DispStringCentered(
                        "\xc4\x90\xc3\xa3 ho\xc3\xa0n t\xe1\xba\xa5t c\xc3\xa2n ch\xe1\xbb\x89nh\n"
                        "m\xc3\xa0n h\xc3\xacnh c\xe1\xba\xa3m \xe1\xbb\xa9ng..."
